...
import org.scribble.editor.trace.policies.*;
...
public class RoleEditPart extends ScenarioBaseEditPart  
	...
	*/
     ...
     * 
     */
	/* GPB: Need to see how role property changes are handled
    ...
    */
    ...
    protected IPropertySource getPropertySource() {
        if (propertySource == null) {
           	propertySource = new org.scribble.editor.trace.view.RolePropertySource(
