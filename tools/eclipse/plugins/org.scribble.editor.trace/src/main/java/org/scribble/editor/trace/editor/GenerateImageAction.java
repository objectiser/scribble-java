...
import org.scribble.editor.trace.parts.ScenarioEditPart;
...
public class GenerateImageAction extends org.eclipse.gef.ui.actions.SelectionAction {
	...
	protected void init() {
		...
		setImageDescriptor(org.scribble.editor.trace.DesignerImages.getImageDescriptor("generate-image.png"));
	}
