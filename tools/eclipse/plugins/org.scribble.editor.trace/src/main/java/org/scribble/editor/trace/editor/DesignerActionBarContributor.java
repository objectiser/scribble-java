...
public class DesignerActionBarContributor extends ActionBarContributor {
    ...
    protected void buildActions() {
        ...
        org.eclipse.ui.actions.RetargetAction act = new org.eclipse.ui.actions.RetargetAction(
        		GenerateImageAction.ID, "Generate Image");
        act.setImageDescriptor(org.scribble.editor.trace.DesignerImages.getImageDescriptor("generate-image.png"));
    ...
    public void contributeToToolBar(IToolBarManager toolBarManager) {
        ...
        toolBarManager.add(new Separator());
        toolBarManager.add(getAction(org.scribble.editor.trace.editor.GenerateImageAction.ID));
    }	
}
