...
import org.scribble.editor.trace.figures.ScenarioFigure;
import org.scribble.editor.trace.model.*;
import org.scribble.editor.trace.policies.ScenarioContainerEditPolicy;
import org.scribble.editor.trace.policies.ScenarioContainerXYLayoutEditPolicy;
...
public class ScenarioEditPart extends ScenarioBaseEditPart
    ...
    protected IPropertySource getPropertySource() {
    	return(new org.scribble.editor.trace.view.ScenarioPropertySource((Scenario)getModel()));
    }
    ...
    public int getChildX(ScenarioBaseEditPart child) {
    	...
    	ret = org.scribble.editor.trace.view.ViewSupport.getChildXPosition(getModel(),
    ...
    public int getChildY(ScenarioBaseEditPart child) {
    	...
    	ret = org.scribble.editor.trace.view.ViewSupport.getChildYPosition(getModel(),
				child.getModel(), getScenarioDiagram());
