...
import org.scribble.editor.trace.dnd.ScenarioTemplateTransferDropTargetListener;
import org.scribble.editor.trace.model.ModelSupport;
import org.scribble.editor.trace.parts.*;
...
public class ScenarioEditorPage extends AbstractEditorPage {
    ...
    private void createGraphicalViewer(Composite parent) {
        ...
        m_viewer.setEditPartFactory(
        		new org.scribble.editor.trace.parts.ScenarioEditPartsFactory());
