...
public class EditorContextMenuProvider extends ContextMenuProvider {
    ...
    private void appendScenarioSubmenu(IMenuManager menuManager) {
        ...
        IAction action = getActionRegistry().getAction(org.scribble.editor.trace.editor.GenerateImageAction.ID);
        ...
        action = getActionRegistry().getAction(org.scribble.editor.trace.editor.CreateLinksAction.ID);
        if (null != action && action.isEnabled())
            submenu.add(action);
